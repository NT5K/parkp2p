...
import ReservationsIncoming from './../components/Dashboard_Reservations_Incoming'
    ...
    return (
        <BrowserRouter>
            ...
            <Navbar />
                ...
                <Route exact path="/dash/incoming" component={ReservationsIncoming} />
                <Route exact path="/dash/car" component={Car} />
                <Route exact path="/dash/date" component={DatePicker} />
